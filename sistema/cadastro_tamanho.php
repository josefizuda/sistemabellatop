...
if( isset($_POST["confirmar"])){
    ...
    if($_POST) {
            ...
            $sql_code = "INSERT INTO order_size (
            size)
            VALUES(
            '$_SESSION[size]'
        )";
        ...
        if($confirma){
            unset(
                $_SESSION['size']);
            echo "<script> location.href='cadastro_tamanho.php'; </script>";
    ...
    ?>
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Cadastro </strong> de Tamanhos
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="" method="post" class="form-horizontal">
                                            <!-- Cadastro de Tamanhos -->
                                            <div class="form-group">
                                                <input required="required" value="" id="size" class="au-input au-input--full" type="text" name="size" placeholder="Informe o Tamanho">
                                            </div>
                                            <!-- botoes -->
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        do {
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td ><?php echo $linha['size']; ?></td>

                                                    <td>
                                                        <div class="table-data-feature">
                                                            <a href="javascript: if(confirm('Tem certeza que deseja deletar <?php echo $linha['size']; ?> ?'))   location.href='deletar_tm.php?p=deletar&id=<?php echo $linha['size_id']; ?>';">
