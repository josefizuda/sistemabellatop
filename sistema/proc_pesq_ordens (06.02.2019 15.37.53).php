...
$sub_array[]='<a href="editar_ordem.php?id='.$row['emit_id'].'" onclick="return confirm(\'Você tem certeza ?\')" class="btn btn-danger"><i class="glyphicon glyphicon-trash">&nbsp;</i>Deletar</a>
