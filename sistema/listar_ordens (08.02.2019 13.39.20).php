    ...
    <div class="section__content section__content--p30">
      ...
      <div class="row">
        <div class="input-daterange">
          <div class="col-md-4">
            <input type="text" name="start_date" id="start_date" class="form-control" placeholder="Data Inicial">
          </div>
          <div class="col-md-4">
            <input type="text" name="end_date" id="end_date" class="form-control"  placeholder="Data Final">
          </div>
          <div class="col-md-4">
            <input type="button" id="search" value="Pesquisar" class="btn btn-info" />
          </div>
        </div>
      </div>
      <br />
          ...
          <table id="tabela" class="table table-striped table-bordered" style="width:100%">
           ...
           <thead>
            <tr>
             ...
             <th nowrap="nowrap" width="10%"> Marca e Tamanho</th>
